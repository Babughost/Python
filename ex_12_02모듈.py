...
print(f'150km = {miles} miles')              # 150km = 93.20565 miles

pounds = converter.gram_to_pounds(1000)      
print(f'1000g = {pounds} pounds')            # 1000g = 2.20462 pounds
...
# 모듈이나 함수의 이름이 긴 경우에 주로 잛은 별명을 지정하고 긴 본래 이름 대신 사용
